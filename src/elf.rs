...
pub struct Constants {
    et: &'static crate::constants::ConstantNames<u16>,
    ef: &'static crate::constants::FlagNames<u32>,
    shn: &'static crate::constants::ConstantNames<u16>,
    sht: &'static crate::constants::ConstantNames<u32>,
    shf: &'static crate::constants::FlagNames<u32>,
    stb: &'static crate::constants::ConstantNames<u8>,
    stt: &'static crate::constants::ConstantNames<u8>,
    sto: &'static crate::constants::FlagNames<u8>,
    pt: &'static crate::constants::ConstantNames<u32>,
    pf: &'static crate::constants::FlagNames<u32>,
    dt: &'static crate::constants::ConstantNames<i64>,
    r: &'static crate::constants::ConstantNames<u32>,
}

impl Constants {
    /// Values for `FileHeader*::e_type`.
    pub fn et(&self) -> &'static crate::constants::ConstantNames<u16> {
        self.et
    }
    /// Values for `FileHeader*::e_flags`.
    pub fn ef(&self) -> &'static crate::constants::FlagNames<u32> {
        self.ef
    }
    /// Special values for section indices.
    pub fn shn(&self) -> &'static crate::constants::ConstantNames<u16> {
        self.shn
    }
    /// Values for `SectionHeader::sh_type`.
    pub fn sht(&self) -> &'static crate::constants::ConstantNames<u32> {
        self.sht
    }
    /// Values for `SectionHeader*::sh_flags`.
    pub fn shf(&self) -> &'static crate::constants::FlagNames<u32> {
        self.shf
    }
    /// Values for `st_bind` component of `Sym*::st_info`.
    pub fn stb(&self) -> &'static crate::constants::ConstantNames<u8> {
        self.stb
    }
    /// Values for `st_type` component of `Sym*::st_info`.
    pub fn stt(&self) -> &'static crate::constants::ConstantNames<u8> {
        self.stt
    }
    /// Values for `Sym*::st_other`.
    pub fn sto(&self) -> &'static crate::constants::FlagNames<u8> {
        self.sto
    }
    /// Values for `ProgramHeader*::p_type`.
    pub fn pt(&self) -> &'static crate::constants::ConstantNames<u32> {
        self.pt
    }
    /// Values for `ProgramHeader*::p_flags`.
    pub fn pf(&self) -> &'static crate::constants::FlagNames<u32> {
        self.pf
    }
    /// Values for `Dyn*::d_tag`.
    pub fn dt(&self) -> &'static crate::constants::ConstantNames<i64> {
        self.dt
    }
    /// Values for `r_type` component of `Rel*::r_info`.
    pub fn r(&self) -> &'static crate::constants::ConstantNames<u32> {
        self.r
    }
}
...
pub const fn machine_constants(machine: u16, _os_abi: u8) -> &'static Constants {
    match machine {
